      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            AI-powered tools designed to make your database schemas understandable
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              title="AI-Generated Data Dictionary"
              value="Auto-Explained"
              subtitle="Automatically generate business-friendly explanations for tables, columns, and relationships using AI"
          ...
          <BentoCard
            ...
            value="Instant"
            subtitle="Connect and extract complete schema metadata from PostgreSQL, Snowflake, or SQL Server"
          ...
          <BentoCard
            ...
            value="Complete"
            subtitle="Measure completeness and freshness to assess data reliability"
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              subtitle="Ask natural language questions and get instant, accurate answers about your schema"
          ...
          <div className="md:col-span-3">
            <BentoCard
              ...
              value="Shareable"
              subtitle="Export AI-generated documentation in Markdown or JSON for easy sharing and reuse"
